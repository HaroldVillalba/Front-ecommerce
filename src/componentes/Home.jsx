...
useEffect(() => {
    ...
    >
        ...
        <h1 className="text-4xl font-bold text-white-1000 mb-4">Bienvenido a Aleluya</h1>
        <p className="text-lg text-white-1000">Explora nuestras funcionalidades y más.</p>
